...
DATA_VAL_LIST = ["bicycle_imagenet", "bicycle_pascal"]
#DATA_TEST_LIST = ["car_imagenet", "car_pascal"]
DATA_TEST_LIST = ["bicycle_imagenet", "bicycle_pascal"]
